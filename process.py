...
def write_script_file(
        ...
        **kwargs ) -> None:
    doredirect : bool = nonzero_keyword( "setupredirect",**kwargs )
    with open(scriptfilename,"w") as scriptfile:

        # header
        scriptfile.write( "#!/bin/bash\n\n" )
        scriptfile.write( f"echo \"Start script: {scripttitle}\"\n" )
        scriptfile.write( f"echo \"This output was generated by: {scriptfilename}\"\n" )
        scriptfile.write( "\n" )
        if doredirect:
