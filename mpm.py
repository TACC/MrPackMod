...
file_actions    : list[str] = \
    [ "download", "unpack", "untar", "retar", "betar", "clone", "pull" ]
build_actions   : list[str] = \
    [ "configure", "build", "module", "public" ]
context_actions : list[str] = \
    [ "dependencies", "listmodules" ]
package_actions : list[str] = \
    [ "package", "version", "test", "url", "configurelog", "logfiles" ]
utility_actions : list[str] = \
    [ "actions", "clean", "regression" ]
